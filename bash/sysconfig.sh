...
function error-message {
	echo "Exited without displaying information." >&2
}
...
function displayhelp {
	...
	sysconfig.sh displays system information. For specific information, enter one of the following options with the command: 
	--host: hostname
	--domain: domain name
	--ipconfig: ip info
	--os: os info
	...
	Enter -h or --help to display this page again.
